...
**Opener (survives "not interested"):**
> "Hey [FIRST NAME] — this isn't a pitch and I'll be quick. I know a water job doesn't wait till morning. When a call comes in at 2am and goes to voicemail, that job's gone to whoever picked up. Real reason I called: I built a phone line that answers those after-hours emergency calls for you and books them. You can call it yourself and hear it — takes 90 seconds. Want the number?"
...
**Subject options:**
- Your 2am calls are going to voicemail
- Who answers when [COMPANY]'s phone rings at 2am?
- Lost a water job to voicemail lately?
- Call this number, hear it answer

**Body:**
> [FIRST NAME] —
>
> When an emergency water call hits after hours and goes to voicemail, that mitigation job goes to whoever answers first. Usually not you.
>
...
## Notes
- No case study yet — do NOT add fake results. The demo IS the proof.
- First-cohort offer (setup waived / month-to-month / live in a week) is the risk reversal — only mention AFTER they've heard the demo where possible.
